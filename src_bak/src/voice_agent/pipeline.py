...
class VoicePipeline:
    ...
    def _p07(self, history: List[Dict[str, str]]) -> List[Dict[str, str]]:
        # 保证历史第 1 条是 system，避免模型上下文漂移。
        if history and history[0].get("role") == "system":
            return history
        return [{"role": "system", "content": SYSTEM_PROMPT}] + history

    def _p11(self, user_text: str) -> str:
    ...
    def run_from_text(
        ...
        work_history = self._p07(history)
        ...
        llm_messages[-1]["content"] = self._p11(user_text)
